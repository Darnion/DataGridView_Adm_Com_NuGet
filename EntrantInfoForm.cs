using DataGridView_Adm_Com_NuGet.Models;

namespace DataGridView_Adm_Com_NuGet
{
    public partial class EntrantInfoForm : Form
    {
        private AdmComDGVNuGet.NuGet_WF nGPkg = new AdmComDGVNuGet.NuGet_WF();
        ...
        {
            nGPkg.FillEnum(Gender.Male, ref comboBoxSex);
            nGPkg.FillEnum(EducationForm.FullTime, ref comboBoxEducationForm);
        }
